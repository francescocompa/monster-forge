...
const GEN_CLASSES={
  Barbarian:{hd:12,gp:75,saves:["str","con"],prim:"str",sec:"con",masteries:2,
    ...
    kits:[
      ...
      {n:"Brute",ac:"hide",tags:["twohand","thrown"],weapons:[{w:"greatclub"},{w:"javelin",count:4},{w:"dagger"}],gear:"Hide Armor, Greatclub, 4 Javelins, Dagger"},
      {n:"Boar hunter",ac:"studded",tags:["twohand","thrown","ranged"],weapons:[{w:"pike"},{w:"handaxe",count:2},{w:"sling"}],gear:"Studded Leather, Pike, 2 Handaxes, Sling, 20 Bullets"},
      {n:"Chieftain's guard",ac:"scaleShield",tags:["onehand"],weapons:[{w:"battleaxe"},{w:"dagger",count:2}],gear:"Scale Mail, Shield, Battleaxe, 2 Daggers"},
      {n:"Raid leader",ac:"chainShirtShield",tags:["onehand","ranged"],weapons:[{w:"flail"},{w:"shortbow"}],gear:"Chain Shirt, Shield, Flail, Shortbow, 20 Arrows"},
      {n:"Dervish",ac:"leather",tags:["dual","finesse"],weapons:[{w:"scimitar",count:2},{w:"handaxe"}],gear:"Leather Armor, 2 Scimitars, Handaxe"}],
  ...
  Bard:{hd:8,gp:90,saves:["dex","cha"],prim:"cha",sec:"dex",
    ...
    kits:[
      ...
      {n:"Wandering minstrel",ac:"leather",tags:["dual","finesse","thrown"],weapons:[{w:"dagger",count:2}],gear:"Leather Armor, 2 Daggers, Lute",gpExtra:35},
      {n:"War drummer",ac:"padded",tags:["onehand","thrown"],weapons:[{w:"spear"},{w:"dagger"}],gear:"Padded Armor, Spear, Dagger, Drum",gpExtra:6},
      {n:"Traveling piper",ac:"leather",tags:["ranged"],weapons:[{w:"lightxbow"},{w:"dagger"}],gear:"Leather Armor, Light Crossbow, 20 Bolts, Dagger, Flute",gpExtra:2},
      {n:"Court poet",ac:"studded",tags:["twohand"],weapons:[{w:"quarterstaff"},{w:"dagger"}],gear:"Studded Leather, Quarterstaff, Dagger, Lyre",gpExtra:30},
      {n:"Herald",ac:"padded",tags:["twohand","ranged"],weapons:[{w:"greatclub"},{w:"sling"}],gear:"Padded Armor, Greatclub, Sling, 20 Bullets, Horn",gpExtra:3},
      {n:"Troubadour",ac:"studded",tags:["onehand","finesse"],weapons:[{w:"rapier"},{w:"dagger"}],gear:"Studded Leather, Rapier, Dagger, Pan Flute",gpExtra:12},
      {n:"Skald",ac:"leather",tags:["onehand","finesse","ranged"],weapons:[{w:"shortsword"},{w:"handxbow"}],gear:"Leather Armor, Shortsword, Hand Crossbow, 20 Bolts, Bagpipes",gpExtra:30},
      {n:"Chamber player",ac:"studded",tags:["ranged"],weapons:[{w:"handxbow"},{w:"dagger"}],gear:"Studded Leather, Hand Crossbow, 20 Bolts, Dagger, Viol",gpExtra:30}],
    traits:[],
  ...
  Cleric:{hd:8,gp:110,saves:["wis","cha"],prim:"wis",sec:"con",
    ...
    kits:[
      ...
      {n:"Shieldbearer",ac:"chainShirtShield",tags:["onehand","ranged"],weapons:[{w:"mace"},{w:"lightxbow"}],gear:"Chain Shirt, Shield, Mace, Light Crossbow, 20 Bolts, Holy Symbol (amulet)"},
      {n:"Field chaplain",ac:"chainShirt",tags:["ranged","onehand"],weapons:[{w:"lightxbow"},{w:"mace"}],gear:"Chain Shirt, Light Crossbow, 20 Bolts, Mace, Holy Symbol (emblem)"},
      {n:"Almoner",ac:"leatherShield",tags:["onehand","ranged"],weapons:[{w:"quarterstaff"},{w:"sling"}],gear:"Leather Armor, Shield, Quarterstaff, Sling, 20 Bullets, Holy Symbol (reliquary)"},
      {n:"Temple guard",ac:"scaleShield",tags:["onehand","thrown","ranged"],weapons:[{w:"spear"},{w:"lightxbow"}],gear:"Scale Mail, Shield, Spear, Light Crossbow, 20 Bolts, Holy Symbol (amulet)"},
      {n:"Wayside preacher",ac:"hide",tags:["twohand","ranged"],weapons:[{w:"greatclub"},{w:"sling"}],gear:"Hide Armor, Greatclub, Sling, 20 Bullets, Holy Symbol (emblem)"},
  ...
  Druid:{hd:8,gp:50,saves:["int","wis"],prim:"wis",sec:"con",
    ...
    kits:[
      ...
      {n:"Grove keeper",ac:"leatherShield",tags:["onehand","ranged"],weapons:[{w:"sickle"},{w:"sling"}],gear:"Leather Armor, Shield, Sickle, Sling, 20 Bullets, Druidic Focus (sprig of mistletoe), Herbalism Kit",gpExtra:5},
      {n:"Plains walker",ac:"padded",tags:["onehand","thrown"],weapons:[{w:"spear"},{w:"dagger"}],gear:"Padded Armor, Spear, Dagger, Druidic Focus (totem)"},
      {n:"Hedge healer",ac:"leather",tags:["twohand","ranged"],weapons:[{w:"sling"},{w:"quarterstaff"}],gear:"Leather Armor, Sling, 20 Bullets, Druidic Focus (wooden staff), Herbalism Kit",gpExtra:5},
      {n:"Circle initiate",ac:"leatherShield",tags:["onehand","ranged"],weapons:[{w:"club"},{w:"sling"}],gear:"Leather Armor, Shield, Club, Sling, 20 Bullets, Druidic Focus (yew wand)"},
      {n:"Storm caller",ac:"studded",tags:["twohand","ranged"],weapons:[{w:"greatclub"},{w:"dart",count:4}],gear:"Studded Leather, Greatclub, 4 Darts, Druidic Focus (sprig of mistletoe), Herbalism Kit",gpExtra:5},
      // Warden-only: the order's Martial weapon and Medium armor training is what makes these legal.
      {n:"Forest guardian",ac:"hideShield",needs:"martialTrained",tags:["onehand","thrown"],weapons:[{w:"battleaxe",noMastery:true},{w:"handaxe",count:2,noMastery:true},{w:"dagger",noMastery:true}],gear:"Hide Armor, Shield, Battleaxe, 2 Handaxes, Dagger, Druidic Focus (totem)"},
      {n:"Thornguard",ac:"scaleShield",needs:"martialTrained",tags:["onehand","finesse"],weapons:[{w:"scimitar",noMastery:true},{w:"dagger",count:2,noMastery:true}],gear:"Scale Mail, Shield, Scimitar, 2 Daggers, Druidic Focus (wooden staff), Herbalism Kit",gpExtra:5}],
  ...
  Fighter:{hd:10,gp:155,saves:["str","con"],prim:["str","dex"],sec:"con",masteries:3,
    ...
    kits:[
      {n:"Line soldier",ac:"chainMailShield",tags:["onehand","thrown"],weapons:[{w:"longsword"},{w:"javelin",count:4},{w:"dagger"}],gear:"Chain Mail, Shield, Longsword, 4 Javelins, Dagger"},
      {n:"Vanguard",ac:"scale",tags:["twohand","thrown"],weapons:[{w:"greatsword"},{w:"handaxe",count:2},{w:"dagger"}],gear:"Scale Mail, Greatsword, 2 Handaxes, Dagger"},
      {n:"Archer",ac:"studded",tags:["ranged","finesse"],weapons:[{w:"longbow"},{w:"shortsword"}],gear:"Studded Leather, Longbow, 20 Arrows, Shortsword"},
      {n:"Whirlwind",ac:"leather",tags:["dual","finesse"],weapons:[{w:"scimitar",count:2},{w:"dagger"}],gear:"Leather Armor, 2 Scimitars, Dagger"},
      {n:"Gatekeeper",ac:"chainMail",tags:["twohand","thrown"],weapons:[{w:"halberd"},{w:"handaxe",count:2},{w:"dagger"}],gear:"Chain Mail, Halberd, 2 Handaxes, Dagger"},
      {n:"Siege guard",ac:"chainShirtShield",tags:["ranged","onehand"],weapons:[{w:"lightxbow"},{w:"mace"},{w:"dagger"}],gear:"Chain Shirt, Shield, Light Crossbow, 20 Bolts, Mace, Dagger"},
      {n:"Shield breaker",ac:"ringMailShield",tags:["onehand","thrown"],weapons:[{w:"warhammer"},{w:"handaxe",count:2},{w:"dagger"}],gear:"Ring Mail, Shield, Warhammer, 2 Handaxes, Dagger"},
      {n:"Duelist",ac:"chainShirt",tags:["onehand","finesse"],weapons:[{w:"rapier"},{w:"dagger",count:2}],gear:"Chain Shirt, Rapier, 2 Daggers"},
      {n:"Blade dancer",ac:"studded",tags:["dual","finesse"],weapons:[{w:"shortsword",count:2},{w:"dagger",count:2}],gear:"Studded Leather, 2 Shortswords, 2 Daggers"},
      {n:"Skirmisher",ac:"hide",tags:["dual","thrown"],weapons:[{w:"handaxe",count:2},{w:"javelin",count:3},{w:"dagger"}],gear:"Hide Armor, 2 Handaxes, 3 Javelins, Dagger"},
      {n:"Sharpshooter",ac:"chainShirt",tags:["ranged","finesse"],weapons:[{w:"heavyxbow"},{w:"shortsword"}],gear:"Chain Shirt, Heavy Crossbow, 20 Bolts, Shortsword"},
      {n:"Reaver",ac:"chainMail",tags:["twohand","thrown"],weapons:[{w:"greataxe"},{w:"javelin",count:3},{w:"dagger"}],gear:"Chain Mail, Greataxe, 3 Javelins, Dagger"},
      {n:"Harrower",ac:"scale",tags:["twohand","thrown"],weapons:[{w:"glaive"},{w:"handaxe",count:2},{w:"dagger"}],gear:"Scale Mail, Glaive, 2 Handaxes, Dagger"},
      {n:"Bulwark",ac:"ringMail",tags:["twohand","thrown","ranged"],weapons:[{w:"pike"},{w:"javelin",count:3},{w:"sling"}],gear:"Ring Mail, Pike, 3 Javelins, Sling, 20 Bullets"},
      {n:"Bruiser",ac:"hideShield",tags:["onehand","thrown"],weapons:[{w:"morningstar"},{w:"lighthammer",count:2},{w:"dagger"}],gear:"Hide Armor, Shield, Morningstar, 2 Light Hammers, Dagger"},
      {n:"Armor breaker",ac:"chainShirtShield",tags:["onehand","thrown"],weapons:[{w:"warpick"},{w:"handaxe",count:2},{w:"dagger"}],gear:"Chain Shirt, Shield, War Pick, 2 Handaxes, Dagger"},
      {n:"Trapper",ac:"leatherShield",tags:["onehand","finesse"],weapons:[{w:"whip"},{w:"shortsword"}],gear:"Leather Armor, Shield, Whip, Shortsword"},
  ...
  Paladin:{hd:10,gp:150,saves:["wis","cha"],prim:"str",sec:"cha",masteries:2,
    ...
    kits:[
      {n:"Oathsworn knight",ac:"chainMailShield",tags:["onehand","thrown"],weapons:[{w:"longsword"},{w:"javelin",count:6},{w:"dagger"}],gear:"Chain Mail, Shield, Longsword, 6 Javelins, Dagger, Holy Symbol (amulet)"},
      {n:"Avenger",ac:"scale",tags:["twohand","thrown"],weapons:[{w:"greatsword"},{w:"javelin",count:3},{w:"dagger"}],gear:"Scale Mail, Greatsword, 3 Javelins, Dagger, Holy Symbol (emblem)"},
      {n:"Justicar",ac:"ringMailShield",tags:["onehand","thrown"],weapons:[{w:"warhammer"},{w:"handaxe",count:2},{w:"dagger"}],gear:"Ring Mail, Shield, Warhammer, 2 Handaxes, Dagger, Holy Symbol (reliquary)"},
      {n:"Inquisitor",ac:"scaleShield",tags:["onehand","ranged"],weapons:[{w:"flail"},{w:"javelin",count:4},{w:"sling"}],gear:"Scale Mail, Shield, Flail, 4 Javelins, Sling, 20 Bullets, Holy Symbol (amulet)"},
      {n:"Zealot",ac:"chainMail",tags:["twohand","thrown"],weapons:[{w:"halberd"},{w:"javelin",count:3},{w:"dagger"}],gear:"Chain Mail, Halberd, 3 Javelins, Dagger, Holy Symbol (emblem)"},
      {n:"Knight errant",ac:"chainShirtShield",tags:["onehand","thrown"],weapons:[{w:"battleaxe"},{w:"handaxe",count:2},{w:"dagger"}],gear:"Chain Shirt, Shield, Battleaxe, 2 Handaxes, Dagger, Holy Symbol (reliquary)"},
      {n:"Cavalier",ac:"chainMailShield",tags:["onehand","thrown"],weapons:[{w:"lance"},{w:"javelin",count:3},{w:"dagger"}],gear:"Chain Mail, Shield, Lance, 3 Javelins, Dagger, Holy Symbol (amulet)"},
      {n:"Standard bearer",ac:"ringMail",tags:["twohand","ranged"],weapons:[{w:"pike"},{w:"javelin",count:4},{w:"lightxbow"}],gear:"Ring Mail, Pike, 4 Javelins, Light Crossbow, 20 Bolts, Holy Symbol (emblem)"},
      // Both priced past the paladin's purse (D-038/D-040) — budget-off kits.
      {n:"Champion",ac:"breastplate",tags:["twohand","thrown"],weapons:[{w:"glaive"},{w:"handaxe",count:2},{w:"dagger"}],gear:"Breastplate, Glaive, 2 Handaxes, Dagger, Holy Symbol (reliquary)"},
      {n:"Vow keeper",ac:"splint",tags:["onehand","ranged"],weapons:[{w:"morningstar"},{w:"javelin",count:4},{w:"handxbow"}],gear:"Splint Armor, Morningstar, 4 Javelins, Hand Crossbow, 20 Bolts, Holy Symbol (amulet)"}],
    traits:[],
  ...
  Ranger:{hd:10,gp:150,saves:["str","dex"],prim:"dex",sec:"wis",masteries:2,
    ...
    kits:[
      {n:"Woodland hunter",ac:"studded",tags:["ranged","finesse"],weapons:[{w:"longbow"},{w:"shortsword"}],gear:"Studded Leather, Longbow, 20 Arrows, Shortsword, Druidic Focus (sprig of mistletoe)"},
      {n:"Border scout",ac:"leather",tags:["dual","finesse"],weapons:[{w:"shortsword",count:2},{w:"dagger",count:2}],gear:"Leather Armor, 2 Shortswords, 2 Daggers, Druidic Focus (yew wand)"},
      {n:"Bounty hunter",ac:"chainShirt",tags:["ranged","finesse"],weapons:[{w:"heavyxbow"},{w:"scimitar"}],gear:"Chain Shirt, Heavy Crossbow, 20 Bolts, Scimitar, Druidic Focus (wooden staff)"},
      {n:"Trail guide",ac:"studdedShield",tags:["onehand","ranged","thrown"],weapons:[{w:"spear"},{w:"shortbow"}],gear:"Studded Leather, Shield, Spear, Shortbow, 20 Arrows, Druidic Focus (totem)"},
      {n:"Beast stalker",ac:"hideShield",tags:["onehand","finesse"],weapons:[{w:"scimitar"},{w:"dagger",count:2}],gear:"Hide Armor, Shield, Scimitar, 2 Daggers, Druidic Focus (sprig of mistletoe)"},
  ...
  Rogue:{hd:8,gp:100,saves:["dex","int"],prim:"dex",sec:"int",masteries:2,
    ...
    kits:[
      ...
      {n:"Shadow",ac:"leather",tags:["onehand","finesse","ranged"],weapons:[{w:"shortsword"},{w:"shortbow"},{w:"dagger",count:2}],gear:"Leather Armor, Shortsword, Shortbow, 20 Arrows, 2 Daggers, Thieves' Tools",gpExtra:25},
      {n:"Cutthroat",ac:"studded",tags:["onehand","finesse"],weapons:[{w:"rapier"},{w:"dagger",count:2}],gear:"Studded Leather, Rapier, 2 Daggers, Thieves' Tools",gpExtra:25},
      {n:"Assassin",ac:"leather",tags:["onehand","finesse","ranged"],weapons:[{w:"rapier"},{w:"handxbow"}],gear:"Leather Armor, Rapier, Hand Crossbow, 20 Bolts, Thieves' Tools",gpExtra:25},
      {n:"Backstabber",ac:"padded",tags:["dual","finesse","ranged"],weapons:[{w:"shortsword",count:2},{w:"sling"}],gear:"Padded Armor, 2 Shortswords, Sling, 20 Bullets, Thieves' Tools",gpExtra:25},
      {n:"Knife collector",ac:"leather",tags:["dual","finesse","thrown"],weapons:[{w:"dagger",count:4},{w:"dart",count:2}],gear:"Leather Armor, 4 Daggers, 2 Darts, Thieves' Tools",gpExtra:25},
      {n:"Outlaw",ac:"studded",tags:["onehand","finesse","ranged"],weapons:[{w:"scimitar"},{w:"shortbow"}],gear:"Studded Leather, Scimitar, Shortbow, 20 Arrows, Thieves' Tools",gpExtra:25},
      {n:"Enforcer",ac:"padded",tags:["onehand","finesse"],weapons:[{w:"whip"},{w:"dagger",count:2}],gear:"Padded Armor, Whip, 2 Daggers, Thieves' Tools",gpExtra:25},
      {n:"Cat burglar",ac:"studded",tags:["onehand","finesse","ranged"],weapons:[{w:"scimitar"},{w:"handxbow"}],gear:"Studded Leather, Scimitar, Hand Crossbow, 20 Bolts, Thieves' Tools",gpExtra:25}],
  ...
  Warlock:{hd:8,gp:100,saves:["wis","cha"],prim:"cha",sec:"con",
    ...
    kits:[
      ...
      {n:"Sworn blade",ac:"leather",needs:"pactBlade",tags:["twohand"],weapons:[{w:"greatsword"},{w:"dagger"}],gear:"Leather Armor, Greatsword, Dagger, Arcane Focus (orb)"},
      {n:"Grim harvester",ac:"leather",needs:"pactBlade",tags:["twohand"],weapons:[{w:"halberd"},{w:"dagger"}],gear:"Leather Armor, Halberd, Dagger, Arcane Focus (staff)"},
      {n:"Nightblade",ac:"studded",needs:"pactBlade",tags:["onehand","finesse"],weapons:[{w:"rapier"},{w:"dagger",count:2}],gear:"Studded Leather, Rapier, 2 Daggers, Arcane Focus (rod)"},
      {n:"Cursed sentinel",ac:"padded",needs:"pactBlade",tags:["twohand","ranged"],weapons:[{w:"glaive"},{w:"handxbow"}],gear:"Padded Armor, Glaive, Hand Crossbow, 20 Bolts, Arcane Focus (crystal)"}],
  ...
  Wizard:{hd:6,gp:55,saves:["int","wis"],prim:"int",sec:"con",
    ...
    kits:[
      {n:"Cloistered adept",ac:"none",tags:["twohand","finesse"],weapons:[{w:"quarterstaff"},{w:"dagger",count:2}],gear:"Quarterstaff (Arcane Focus), 2 Daggers, Robe, Spellbook"},
...
// VOICE (B305, his call): SECOND PERSON, every row a whole sentence starting "You ". The list used
// to be headless third person ("Counts everything out loud") with 33 rows saying "it" — written
// when the crew was kobolds only, so after B288 it was calling a human paladin "it". A pronoun swap
// alone doesn't work here: the card renders "<b>Quirk:</b> <text>", so the row has to be a sentence
// whose subject is the reader. It also matches both trinket lists, which already say "you"/"your".
// The only "it" left in the list is an OBJECT pronoun (follow it, regret it) — keep it that way.
const GEN_QUIRKS=[
  "You count everything out loud, badly","You name every weapon you pick up",
  "You refuse to walk through a door someone else opened","You repeat the last word anyone says",
  "You keep a tally of debts owed to you, on your arm","You eat anything with a face, first",
  "You apologize to doors before forcing them","You whistle when nervous, which is often",
  "You collect buttons off the dead","You talk to your shadow when you think nobody is listening",
  "You never sit with your back to a room","You salute anyone taller",
  "You believe you are invisible when you hold still","You insist on going first, out of pride",
  "You crack your knuckles before lying","You hum the same six notes constantly",
  "You refuse to say your own name aloud","You reword every order you are given, then follow it",
  "You won't touch gold with bare hands","You lick unfamiliar objects",
  "You flinch at loud noises, then pretend you didn't","You sharpen a blade that is already sharp",
  "You sleep with one boot on","You argue with corpses","You bow before attacking",
  "You keep a running list of things that nearly killed you","You distrust anything that floats",
  "You always take the smallest portion, loudly","You steal salt",
  "You narrate your own actions in the third person",
  "You refuse to cross running water without asking permission",
  "You blame the nearest object when you trip","You keep stones in your pockets to feel heavier",
  "You wear a talisman you know is fake","You try to bargain with anything that talks",
  "You insist on opening every chest","You whisper when discussing money",
  "You draw maps that nobody else can read","You mark every room you have survived",
  "You feed the first bite of every meal to the floor",
  "You speak to animals as equals, and wait for answers",
  "You snore loudly enough to be a tactical problem",
  "You fuss over the party's gear before your own","You refuse to be thanked",
  "You name the dead out loud each morning","You won't step on cracks, in dungeons or out",
  "You trust anyone who feeds you","You wear trophies from fights you lost",
  "You practice your last words","You correct other people's grammar mid-fight",
  "You believe you are the reincarnation of something great",
  "You rub a lucky scar before every risk","You will not lie, but you omit generously",
  "You answer questions with questions","You cannot resist a bet",
  "You wrap your hands before a fight, ritually","You refuse to sleep in a bed",
  "You divide all loot into equal piles, obsessively",
  "You won't fight anything smaller than yourself","You keep your old shackle as a bracelet",
  "You say grace over fallen enemies","You never learn a name, and use job titles instead",
  "You taste the air before entering a room","You keep a pebble for each friend still living",
  "You hate being touched on the shoulder","You volunteer for everything first, then regret it",
  "You talk about yourself in the plural","You assume every stranger is an old acquaintance",
  "You won't part with a broken weapon","You insist the walls are listening",
  "You put your gear in the same order every night","You refuse to be carried, ever",
  "You bite your cloak when concentrating","You claim to be allergic to magic",
  "You sneeze near gold","You bury what you cannot carry, and remember where",
  "You call every big creature sir","You trade away useful things for shiny ones",
  "You insist on carrying the light, then walk too fast","You freeze solid at the sight of a rat",
  "You tell the same story every night, differently each time","You only wear red",
  "You adopt anything small that survives","You swear elaborate oaths over trivial things",
  "You keep a written will, updated weekly","You test every ladder with one foot, twice",
  "You give directions nobody asked for","You fall asleep instantly, anywhere, mid-sentence",
  "You assume the loudest person is in charge","You explain the plan back to the party, wrongly",
  "You wince at your own jokes","You take off your boots to think",
  "You answer for other people before they can","You say goodbye to rooms",
  "You warm up before a fight like an athlete","You stop mid-fight to check who is still standing",
  "You cannot whisper, and believe you are whispering","You volunteer other people for things",
  "You refuse to spend the last coin in your purse",
  "You keep talking for a while after everyone has left"
];
