...
// Official 2014 DMG p.274 "Monster Statistics by Challenge Rating" table (T1.1) — the canonical
// STARTING structure for the hybrid CR-math model (Q1.A): 2014 table shape, recalibrated against the
// 2024 corpus in a later pass (TASKS.md T1.2's calibration spike decides the final numbers). Columns:
// [AC, HP min, HP max, Attack Bonus, DPR min, DPR max, Save DC]. CR0's AC/Attack/DC are printed in the
// book as "13 or lower" / "+3 or lower" / "13 or lower" — stored here as their ceiling.
// NOTE: BOH above predates this table and already diverges from it at most CRs (notably lower HP, and
// AC/Attack drifting the other way at high CR) — it's an earlier ad hoc approximation, not a transcription
// of this table. T1.2 decides which numbers win; don't silently reconcile the two here.
const CR_EXPECT={"0":[13,1,6,3,0,1,13],"1/8":[13,7,35,3,2,3,13],"1/4":[13,36,49,3,4,5,13],"1/2":[13,50,70,3,6,8,13],"1":[13,71,85,3,9,14,13],"2":[13,86,100,3,15,20,13],"3":[13,101,115,4,21,26,13],"4":[14,116,130,5,27,32,14],"5":[15,131,145,6,33,38,15],"6":[15,146,160,6,39,44,15],"7":[15,161,175,6,45,50,15],"8":[16,176,190,7,51,56,16],"9":[16,191,205,7,57,62,16],"10":[17,206,220,7,63,68,16],"11":[17,221,235,8,69,74,17],"12":[17,236,250,8,75,80,17],"13":[18,251,265,8,81,86,18],"14":[18,266,280,8,87,92,18],"15":[18,281,295,8,93,98,18],"16":[18,296,310,9,99,104,18],"17":[19,311,325,10,105,110,19],"18":[19,326,340,10,111,116,19],"19":[19,341,355,10,117,122,19],"20":[19,356,400,10,123,140,19],"21":[19,401,445,11,141,158,20],"22":[19,446,490,11,159,176,20],"23":[19,491,535,11,177,194,20],"24":[19,536,580,12,195,212,21],"25":[19,581,625,12,213,230,21],"26":[19,626,670,12,231,248,21],"27":[19,671,715,13,249,266,22],"28":[19,716,760,13,267,284,22],"29":[19,761,805,13,285,302,22],"30":[19,806,850,14,303,320,23]};
