# ARCHIVE — Monster Forge

Bodies moved out of the live docs so `/resume`'s cold read stays cheap. **Nothing here was deleted**;
every section left a one-line stub pointing at it. Live docs remain the complete index — this file
holds the parts a cold session doesn't need to do the next task.

Created 2026-08-10 (`/clean` pass at `3716887`).

---

## Holistic audit, 2026-07-01 (Batch 249, `929c03b`)

STATUS: fully consumed — every finding fixed across B250–B254. Moved out of the live set
2026-08-10; the next audit starts fresh rather than extending this one.

<details>
<summary>Full audit body</summary>
...
## Changelog, Batch 274 and older (Phase 1 and everything before it)

The live `CHANGELOG.md` keeps Batch 275 onward — Phase 2's opening and the whole crew-generator
arc, i.e. the last two milestones. Everything below is Phase 1's close and the 273 batches
before it, moved 2026-08-10.
...
## TASKS: side quest 1, crew generator follow-ups

Moved 2026-08-10 — all four shipped in B297.
...
## TASKS: Phase 2 shipped task bodies

Moved 2026-08-10 — T2.1–T2.4 shipped in B275–B278; the live doc keeps a one-line row each
and points at DEVELOPMENT.md, which owns the schema itself.
